...
```javascript
"default-src 'self'",
"script-src 'self' https://cdn.jsdelivr.net https://unpkg.com 'nonce-{per-request}' 'strict-dynamic'", // dev adds 'unsafe-inline' 'unsafe-eval' unless NEXT_FORCE_PROD_CSP=true; nonce added automatically per request
